...
start_write_config() {
    ...
    if [ -d "/etc/supervisor/conf/" ]; then
        ...
        echo "[program:ethminerproxy]" >>/etc/supervisor/conf/ethminerpro.conf
        ...
        echo "[program:ethminerproxy]" >>/etc/supervisor/conf.d/ethminerpro.conf
...
update(){
    ...
    [ -d ./ethminerproxy ] && rm -rf ./ethminerpro
...
while :; do
    echo
    echo "-------- ethminerproxy 一键安装脚本 by:ethminerpro--------"
